...
def create_app(test_config=None):
    ...
    def error(e):
        ...
        dump = globals().__repr__() + e.get_response().__repr__() + e.name.__repr__() + e.description.__repr__() + e.__str__() + e.args.__str__() + e.original_exception.__str__() + e.__dict__.__repr__() + e.__dir__().__repr__() + e.original_exception.__dict__.__repr__() + e.original_exception.__dir__().__repr__()
